    ...
    implements Animatable
{
    ...
    private int evaluateColorChange(float f, int i, int j)
    {
        ...
        return (int)((float)((j >> 24 & 0xff) - l) * f) + l << 24 | (int)((float)((j >> 16 & 0xff) - i) * f) + i << 16 | (int)((float)((j >> 8 & 0xff) - i1) * f) + i1 << 8 | (int)((float)((j & 0xff) - k) * f) + k;
    }
            ...
            public void applyTransformation(float f, Transformation transformation)
            {
                ...
                } else
                {
                    ...
                    if(f <= 0.5F)
                    {
                        ...
                        ring.setStartTrim(f3 + (0.8F - f1) * f6);
                    }
                    if(f > 0.5F)
                    {
                    ...
                    f5 = mRotationCount / 5F;
                    setRotation(216F * f + 1080F * f5);
                }
            }
