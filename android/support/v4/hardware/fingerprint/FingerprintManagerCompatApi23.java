...
;
    ...
    {
        android.hardware.fingerprint.FingerprintManager.CryptoObject cryptoobject1 = null;
        if(cryptoobject != null) goto _L2; else goto _L1
_L1:
        return cryptoobject1;
_L2:
        if(cryptoobject.getCipher() != null)
            cryptoobject1 = new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getCipher());
        else
        if(cryptoobject.getSignature() != null)
            cryptoobject1 = new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getSignature());
        else
        if(cryptoobject.getMac() != null)
            cryptoobject1 = new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getMac());
        if(true) goto _L1; else goto _L3
_L3:
    }
