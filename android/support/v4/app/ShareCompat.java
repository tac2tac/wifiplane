...
_L3:
        ...
        public String getHtmlText()
        {
            String s;
            String s1;
            s = mIntent.getStringExtra("android.intent.extra.HTML_TEXT");
            s1 = s;
...
_L3:
            s1 = Html.toHtml((Spanned)charsequence);
_L2:
            return s1;
_L4:
            s1 = s;
            if(charsequence != null)
                s1 = ShareCompat.IMPL.escapeHtml(charsequence);
...
_L5:
    ...
    public static ComponentName getCallingActivity(Activity activity)
    {
        ...
        if(componentname == null)
            componentname1 = (ComponentName)activity.getIntent().getParcelableExtra("android.support.v4.app.EXTRA_CALLING_ACTIVITY");
    ...
    public static String getCallingPackage(Activity activity)
    {
        ...
        String s1 = s;
        if(s == null)
            s1 = activity.getIntent().getStringExtra("android.support.v4.app.EXTRA_CALLING_PACKAGE");
        return s1;
    }
