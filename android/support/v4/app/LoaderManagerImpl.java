...
_L3:
    ...
    public void dump(String s, FileDescriptor filedescriptor, PrintWriter printwriter, String as[])
    {
        if(mLoaders.size() > 0)
        {
            ...
            {
                LoaderInfo loaderinfo1 = (LoaderInfo)mLoaders.valueAt(i);
                printwriter.print(s);
                printwriter.print("  #");
        ...
        if(mInactiveLoaders.size() > 0)
        {
            ...
            {
                LoaderInfo loaderinfo = (LoaderInfo)mInactiveLoaders.valueAt(j);
                printwriter.print(s);
                printwriter.print("  #");
                printwriter.print(mInactiveLoaders.keyAt(j));
                printwriter.print(": ");
                printwriter.println(loaderinfo.toString());
                loaderinfo.dump(s2, filedescriptor, printwriter, as);
            }
...
_L2:
        bundle = createAndInstallLoader(i, bundle, loadercallbacks).mLoader;
_L7:
        return bundle;
_L6:
        ...
        bundle = loaderinfo.mPendingLoader.mLoader;
