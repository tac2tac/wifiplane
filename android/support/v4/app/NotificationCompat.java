...
//            NotificationCompatApi20, NotificationCompatKitKat, NotificationCompatBase, NotificationCompatApi21, 
...
;
        ...
        implements NotificationCompatImpl
    {
        ...
        public Notification build(Builder builder, BuilderExtender builderextender)
        {
            builderextender = NotificationCompatBase.add(builder.mNotification, builder.mContext, builder.mContentTitle, builder.mContentText, builder.mContentIntent);
    ...
    static class NotificationCompatImplGingerbread extends NotificationCompatImplBase
    {
        ...
        public Notification build(Builder builder, BuilderExtender builderextender)
        {
            builderextender = NotificationCompatGingerbread.add(builder.mNotification, builder.mContext, builder.mContentTitle, builder.mContentText, builder.mContentIntent, builder.mFullScreenIntent);
            if(builder.mPriority > 0)
                builderextender.flags = ((Notification) (builderextender)).flags | 0x80;
            return builderextender;
        }
...
_L5:
    ...
    private static Notification[] getNotificationArrayFromBundle(Bundle bundle, String s)
    {
        ...
        {
            bundle = (Notification[])aparcelable;
        } else
        {
