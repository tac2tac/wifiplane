...
_L3:
        ...
        {
            boolean flag;
            if((view instanceof ScrollingView) && canScrollingViewScrollHorizontally((ScrollingView)view, i))
                flag = true;
            else
                flag = false;
            return flag;
        ...
        {
            boolean flag;
            if((view instanceof ScrollingView) && canScrollingViewScrollVertically((ScrollingView)view, i))
                flag = true;
            else
                flag = false;
            return flag;
...
_L1:
        ...
        public boolean dispatchNestedFling(View view, float f, float f1, boolean flag)
        {
            if(view instanceof NestedScrollingChild)
                flag = ((NestedScrollingChild)view).dispatchNestedFling(f, f1, flag);
            else
                flag = false;
            return flag;
        }
        ...
        public boolean dispatchNestedPreFling(View view, float f, float f1)
        {
            boolean flag;
            if(view instanceof NestedScrollingChild)
                flag = ((NestedScrollingChild)view).dispatchNestedPreFling(f, f1);
            else
                flag = false;
            return flag;
        }
        ...
        public boolean dispatchNestedPreScroll(View view, int i, int j, int ai[], int ai1[])
        {
            boolean flag;
            if(view instanceof NestedScrollingChild)
                flag = ((NestedScrollingChild)view).dispatchNestedPreScroll(i, j, ai, ai1);
            else
                flag = false;
            return flag;
        }
        ...
        public boolean dispatchNestedScroll(View view, int i, int j, int k, int l, int ai[])
        {
            boolean flag;
            if(view instanceof NestedScrollingChild)
                flag = ((NestedScrollingChild)view).dispatchNestedScroll(i, j, k, l, ai);
            else
                flag = false;
            return flag;
        }
...
_L1:
        ...
        public boolean hasNestedScrollingParent(View view)
        {
            boolean flag;
            if(view instanceof NestedScrollingChild)
                flag = ((NestedScrollingChild)view).hasNestedScrollingParent();
            else
                flag = false;
            return flag;
        }
        ...
        public boolean isNestedScrollingEnabled(View view)
        {
            boolean flag;
            if(view instanceof NestedScrollingChild)
                flag = ((NestedScrollingChild)view).isNestedScrollingEnabled();
            else
                flag = false;
            return flag;
        }
        ...
        public boolean startNestedScroll(View view, int i)
        {
            boolean flag;
            if(view instanceof NestedScrollingChild)
                flag = ((NestedScrollingChild)view).startNestedScroll(i);
            else
                flag = false;
            return flag;
        }
    ...
    static class ICSViewCompatImpl extends HCViewCompatImpl
    {
        ...
        public ViewPropertyAnimatorCompat animate(View view)
        {
            ...
            ViewPropertyAnimatorCompat viewpropertyanimatorcompat1 = viewpropertyanimatorcompat;
            if(viewpropertyanimatorcompat == null)
            {
                viewpropertyanimatorcompat1 = new ViewPropertyAnimatorCompat(view);
                mViewPropertyAnimatorCompatMap.put(view, viewpropertyanimatorcompat1);
            }
...
_L3:
    ...
    static class JBViewCompatImpl extends ICSMr1ViewCompatImpl
    {
        ...
        public AccessibilityNodeProviderCompat getAccessibilityNodeProvider(View view)
        {
            ...
            if(view != null)
                view = new AccessibilityNodeProviderCompat(view);
            else
                view = null;
            return view;
        }
