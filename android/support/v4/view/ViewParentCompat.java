        ...
        implements ViewParentCompatImpl
    {
        ...
        public boolean onNestedFling(ViewParent viewparent, View view, float f, float f1, boolean flag)
        {
            if(viewparent instanceof NestedScrollingParent)
                flag = ((NestedScrollingParent)viewparent).onNestedFling(view, f, f1, flag);
            else
                flag = false;
            return flag;
        }
        ...
        public boolean onNestedPreFling(ViewParent viewparent, View view, float f, float f1)
        {
            boolean flag;
            if(viewparent instanceof NestedScrollingParent)
                flag = ((NestedScrollingParent)viewparent).onNestedPreFling(view, f, f1);
            else
                flag = false;
            return flag;
        }
        ...
        public boolean onStartNestedScroll(ViewParent viewparent, View view, View view1, int i)
        {
            boolean flag;
            if(viewparent instanceof NestedScrollingParent)
                flag = ((NestedScrollingParent)viewparent).onStartNestedScroll(view, view1, i);
            else
                flag = false;
            return flag;
        }
