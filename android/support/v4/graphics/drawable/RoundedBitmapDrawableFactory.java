...
public final class RoundedBitmapDrawableFactory
{
    ...
    public static RoundedBitmapDrawable create(Resources resources, Bitmap bitmap)
    {
        if(android.os.Build.VERSION.SDK_INT >= 21)
            ...
            resources = new DefaultRoundedBitmapDrawable(resources, bitmap);
        return resources;
    }
    ...
    public static RoundedBitmapDrawable create(Resources resources, InputStream inputstream)
    {
        ...
        if(resources.getBitmap() == null)
            Log.w("RoundedBitmapDrawableFactory", (new StringBuilder()).append("RoundedBitmapDrawable cannot decode ").append(inputstream).toString());
        return resources;
    }
