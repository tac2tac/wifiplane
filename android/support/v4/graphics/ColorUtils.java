...
_L4:
        ...
        k = Math.round(255F * (f1 + f2));
        l = Math.round(255F * (f3 + f2));
        continue; /* Loop/switch isn't completed */
_L5:
        j = Math.round(255F * f2);
        k = Math.round(255F * (f3 + f2));
        l = Math.round(255F * (f1 + f2));
        continue; /* Loop/switch isn't completed */
_L6:
        j = Math.round(255F * (f3 + f2));
...
_L2:
        ...
        f = ((f1 - f2) / f5) % 6F;
_L5:
        f3 = f5 / (1.0F - Math.abs(2.0F * f6 - 1.0F));
        f5 = f;
        f = f3;
...
_L6:
    ...
    public static int XYZToColor(double d, double d1, double d2)
    {
        ...
        if(d3 > 0.0031308D)
            d = 1.0549999999999999D * Math.pow(d3, 0.41666666666666669D) - 0.055D;
        else
            d = d3 * 12.92D;
        if(d4 > 0.0031308D)
            d1 = 1.0549999999999999D * Math.pow(d4, 0.41666666666666669D) - 0.055D;
        else
            d1 = d4 * 12.92D;
        if(d2 > 0.0031308D)
...
_L3:
        c = j1;
        if(j1 - i1 <= 1) goto _L4; else goto _L5
_L5:
        int k = (i1 + j1) / 2;
        if(calculateContrast(setAlphaComponent(i, k), j) < (double)f)
            i1 = k;
        else
            j1 = k;
        l++;
