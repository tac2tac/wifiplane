...
;
    ...
    public static PlaybackStateCompat fromPlaybackState(Object obj)
    {
        ...
        {
            Object obj1 = PlaybackStateCompatApi21.getCustomActions(obj);
            Object obj2 = null;
            if(obj1 != null)
            {
                ...
                do
                {
                    ...
                    if(!((Iterator) (obj1)).hasNext())
                        break;
                    arraylist.add(CustomAction.fromCustomAction(((Iterator) (obj1)).next()));
                } while(true);
            }
            Bundle bundle;
            if(android.os.Build.VERSION.SDK_INT >= 22)
                ...
                bundle = null;
            obj2 = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(obj), PlaybackStateCompatApi21.getPosition(obj), PlaybackStateCompatApi21.getBufferedPosition(obj), PlaybackStateCompatApi21.getPlaybackSpeed(obj), PlaybackStateCompatApi21.getActions(obj), PlaybackStateCompatApi21.getErrorMessage(obj), PlaybackStateCompatApi21.getLastPositionUpdateTime(obj), ((List) (obj2)), PlaybackStateCompatApi21.getActiveQueueItemId(obj), bundle);
            obj2.mStateObj = obj;
            obj = obj2;
        }
    ...
    public Object getPlaybackState()
    {
        ...
        } else
        {
            ...
            {
                ArrayList arraylist = new ArrayList(mCustomActions.size());
                ...
                do
                {
                    ...
                    if(!iterator.hasNext())
                        break;
                    arraylist.add(((CustomAction)iterator.next()).getCustomAction());
                } while(true);
            }
            if(android.os.Build.VERSION.SDK_INT >= 22)
